...
:ok-here-we-go
   ...
   expect     "\r\n*MARK DSC4 OFF BEFORE YOU GO" send "mark dsc4:,off ; display devices\r";c  ;# sometimes it goes like this
   expect "*\177\177MARK DSC4 OFF BEFORE YOU GO" send "mark dsc4:,off ; display devices\r";c  ;# sometimes with octal 177 (DEL)
